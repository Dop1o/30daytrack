const I18n = {
    ...
    translations: {
        ru: {
            ...
            templates_section_title: "Быстрые шаблоны",
            templates_section_subtitle: "Популярные привычки — один клик, и трекер готов. Можно сразу отмечать прогресс.",
            template_btn_start: "Начать",
            template_create_custom: "Создать свой",

            template_sugar_name: "30 дней без сахара",
            template_sugar_desc: "Меньше сладкого — больше энергии и контроля за питанием.",
            template_sugar_goal: "30 дней без добавленного сахара: без сладостей, десертов и сахара в напитках; отмечать каждый «чистый» день.",

            template_read_name: "Читать 20 мин/день",
            template_read_desc: "Ежедневное чтение без давления — только регулярность.",
            template_read_goal: "Каждый день читать не менее 20 минут: книга, статьи или учебные материалы — главное ежедневная практика.",

            template_water_name: "2 литра воды",
            template_water_desc: "Поддержка водного баланса и самочувствия каждый день.",
            template_water_goal: "Выпивать около 2 литров чистой воды в день, распределяя объём равномерно; отмечать дни, когда норма выполнена.",

            template_pushups_name: "Отжимания",
            template_pushups_desc: "Сила верхней части тела за 30 дней последовательных тренировок.",
            template_pushups_goal: "Ежедневно выполнять отжимания по выбранной программе (например, добавлять по 1–2 повторения); отмечать выполненные дни.",

            template_meditation_name: "Медитация",
            template_meditation_desc: "Короткие практики для спокойствия и концентрации.",
            template_meditation_goal: "Каждый день практиковать медитацию или осознанное дыхание 5–15 минут; отмечать дни с завершённой сессией.",

            template_english_name: "Английский язык",
            template_english_desc: "Регулярные уроки или практика — язык лучше запоминается.",
            template_english_goal: "Заниматься английским каждый день: урок, приложение, подкаст или разговорная практика не менее 15 минут.",

            template_steps_name: "10 000 шагов",
            template_steps_desc: "Больше движения в течение дня — привычка к активности.",
            template_steps_goal: "Набирать не менее 10 000 шагов в день (или ближайшую к цели дистанцию); отмечать дни, когда цель достигнута.",

            template_wakeup_name: "Ранний подъем",
            template_wakeup_desc: "Стабильный режим сна и бодрое начало дня.",
            template_wakeup_goal: "Подниматься в одно и то же «раннее» время каждый день и начинать день без откладывания будильника; отмечать успешные дни.",

            template_nosmoke_name: "Не курить",
            template_nosmoke_desc: "30 дней без сигарет — шаг к свободному дыханию и здоровью.",
            template_nosmoke_goal: "30 дней без курения и альтернатив с никотином; отмечать каждый день, когда удалось удержаться без срыва.",

            template_sleep_name: "Сон 7–8 часов",
            template_sleep_desc: "Стабильный сон — основа восстановления и продуктивности.",
            template_sleep_goal: "Каждую ночь спать 7–8 часов в одном и том же окне; вести трекер и отмечать дни, когда режим сна соблюдён.",
            ...
            modal_share_tab_link: "Ссылка",
            modal_share_tab_card: "Карточка прогресса",
            modal_share_card_intro: "Сгенерируйте изображение с сеткой 30 дней и поделитесь прогрессом.",
            modal_share_card_generate: "Сгенерировать и поделиться",
            modal_share_card_regenerate: "Создать заново",
            modal_share_card_download_png: "Скачать PNG",
            modal_share_card_copy_clipboard: "Копировать в буфер",
            modal_share_card_retry: "Попробовать ещё раз",
            modal_share_card_generating: "Генерация…",
            share_card_day_line: "День {x} из 30",
            error_share_card_generation: "Не удалось создать изображение. Попробуйте ещё раз.",
            error_share_image_clipboard: "Не удалось скопировать изображение. Скачайте PNG или проверьте разрешения браузера.",
            notification_share_png_saved: "PNG сохранён",
            notification_share_image_copied: "Изображение скопировано в буфер обмена",

            notif_settings_summary: "Настройки уведомлений",
            notif_time_label: "Время напоминания",
            notif_settings_hint: "Напоминание только на этом устройстве, без сервера. Время — локальное.",
            notif_request_permission: "Запросить разрешение",
            notif_reminder_title: "30Day Track",
            notif_reminder_body: "День {x}: отметь прогресс в трекере «{name}»",
            notif_unsupported: "Браузер не поддерживает уведомления",
            notif_granted: "Разрешение получено — напоминания включены",
            notif_denied: "Уведомления недоступны без разрешения",
            toast_new_streak_record: "🎉 Новый рекорд! 🎉",

            onboarding_skip: "Пропустить",
            onboarding_next: "Далее",
            onboarding_finish: "Начать",
            onboarding_step1_title: "Добро пожаловать!",
            onboarding_step1_text: "30-дневный трекер помогает закрепить привычку: один челлендж, один фокус, видимый прогресс каждый день.",
            onboarding_step2_title: "Быстрые шаблоны",
            onboarding_step2_text: "Выберите готовую привычку из шаблонов или создайте свой трекер с нуля — за пару секунд.",
            onboarding_step3_title: "Отмечайте дни",
            onboarding_step3_text: "Каждый выполненный день — галочка в календаре. Статистика и серии мотивируют не срываться.",
            onboarding_step4_title: "Готовы?",
            onboarding_step4_text: "Начните с шаблона или своего челленджа. Через 30 дней вы увидите результат.",

            milestone_day_1: "Ты начал. 80% людей только планируют — ты уже действуешь.",
            milestone_day_7: "Первая неделя. Дофаминовая петля запущена — дальше легче.",
            milestone_day_14: "Полпути. Твой мозг уже перестраивает нейронные связи.",
            milestone_day_21: "Привычка сформирована на 90%. Осталось закрепить.",
            milestone_day_30_title: "30 дней!",
            milestone_day_30: "Ты прошёл весь путь. Не останавливайся — закрепи привычку и начни новый челлендж.",
        ...
        en: {
            ...
            templates_section_title: "Quick templates",
            templates_section_subtitle: "Popular habits — one tap and your tracker is ready. You can log progress right away.",
            template_btn_start: "Start",
            template_create_custom: "Build your own",

            template_sugar_name: "30 days without sugar",
            template_sugar_desc: "Less added sugar — more energy and mindful eating.",
            template_sugar_goal: "30 days without added sugar: no sweets, desserts, or sugar in drinks; check off each successful day.",

            template_read_name: "Read 20 min/day",
            template_read_desc: "Daily reading without pressure — consistency is what counts.",
            template_read_goal: "Read at least 20 minutes every day — books, articles, or study material; the key is a daily habit.",

            template_water_name: "2 liters of water",
            template_water_desc: "Stay hydrated and support how you feel every day.",
            template_water_goal: "Drink about 2 liters of plain water per day, spread across the day; mark each day you hit the goal.",

            template_pushups_name: "Push-ups",
            template_pushups_desc: "Upper-body strength over 30 days of steady training.",
            template_pushups_goal: "Do push-ups daily using a simple progression (e.g. add 1–2 reps over time); mark days you complete the session.",

            template_meditation_name: "Meditation",
            template_meditation_desc: "Short practices for calm and focus.",
            template_meditation_goal: "Practice meditation or mindful breathing 5–15 minutes every day; mark days you finish a session.",

            template_english_name: "English",
            template_english_desc: "Regular lessons or practice — retention improves with routine.",
            template_english_goal: "Study English every day: app, lesson, podcast, or speaking practice for at least 15 minutes.",

            template_steps_name: "10,000 steps",
            template_steps_desc: "More movement through the day — build an active habit.",
            template_steps_goal: "Walk at least 10,000 steps per day (or your closest realistic target); mark days you reach it.",

            template_wakeup_name: "Early wake-up",
            template_wakeup_desc: "A steady sleep rhythm and a strong start to the morning.",
            template_wakeup_goal: "Wake up at the same early time every day and get up without snoozing; mark successful mornings.",

            template_nosmoke_name: "No smoking",
            template_nosmoke_desc: "30 days smoke-free — clearer breathing and better health.",
            template_nosmoke_goal: "30 days without cigarettes or nicotine substitutes; mark each day you stay on track without a slip.",

            template_sleep_name: "7–8 hours of sleep",
            template_sleep_desc: "Consistent sleep supports recovery and focus.",
            template_sleep_goal: "Sleep 7–8 hours each night in a stable window; mark days you kept your sleep schedule.",
            ...
            modal_share_tab_link: "Link",
            modal_share_tab_card: "Progress card",
            modal_share_card_intro: "Generate a 30-day grid image and share your progress.",
            modal_share_card_generate: "Generate & share",
            modal_share_card_regenerate: "Regenerate",
            modal_share_card_download_png: "Download PNG",
            modal_share_card_copy_clipboard: "Copy to clipboard",
            modal_share_card_retry: "Try again",
            modal_share_card_generating: "Generating…",
            share_card_day_line: "Day {x} of 30",
            error_share_card_generation: "Could not create the image. Please try again.",
            error_share_image_clipboard: "Could not copy the image. Download PNG or check browser permissions.",
            notification_share_png_saved: "PNG saved",
            notification_share_image_copied: "Image copied to clipboard",

            notif_settings_summary: "Notification settings",
            notif_time_label: "Reminder time",
            notif_settings_hint: "Local reminders in your browser only, no server. Time is your device local time.",
            notif_request_permission: "Request permission",
            notif_reminder_title: "30Day Track",
            notif_reminder_body: "Day {x}: log progress in \"{name}\"",
            notif_unsupported: "Notifications are not supported in this browser",
            notif_granted: "Permission granted — reminders enabled",
            notif_denied: "Notifications need permission to work",
            toast_new_streak_record: "🎉 New record! 🎉",

            onboarding_skip: "Skip",
            onboarding_next: "Next",
            onboarding_finish: "Get started",
            onboarding_step1_title: "Welcome!",
            onboarding_step1_text: "The 30-day tracker helps you build a habit: one challenge, one focus, visible progress every day.",
            onboarding_step2_title: "Quick templates",
            onboarding_step2_text: "Pick a ready-made habit or create your own tracker from scratch — in seconds.",
            onboarding_step3_title: "Check off days",
            onboarding_step3_text: "Each completed day is a check in the calendar. Stats and streaks keep you going.",
            onboarding_step4_title: "Ready?",
            onboarding_step4_text: "Start with a template or your own challenge. In 30 days you'll see the result.",

            milestone_day_1: "You started. 80% of people only plan — you're already acting.",
            milestone_day_7: "First week done. The dopamine loop is on — it gets easier.",
            milestone_day_14: "Halfway there. Your brain is already rewiring.",
            milestone_day_21: "Habit is 90% formed. Time to lock it in.",
            milestone_day_30_title: "30 days!",
            milestone_day_30: "You finished the journey. Don't stop — reinforce the habit and start a new challenge.",
            ...
            stat_best_streak: "Record: {x} days",
